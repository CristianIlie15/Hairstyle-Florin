...
function App() {
  return (
    <section className="relative w-full min-h-[600px] md:min-h-[720px] overflow-hidden">
      ...
      {/* Content container */}
      <div className="relative z-10 w-full flex flex-col items-center justify-center text-center text-white p-6 md:w-1/2 md:ml-auto md:items-start md:text-left md:p-12 mt-[40%] md:mt-[24%] lg:mt-[10%]">
